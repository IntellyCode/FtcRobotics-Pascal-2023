package org.firstinspires.ftc.teamcode.additional.drive;
...
import org.firstinspires.ftc.teamcode.additional.trajectorysequence.TrajectorySequence;
import org.firstinspires.ftc.teamcode.additional.trajectorysequence.TrajectorySequenceBuilder;
import org.firstinspires.ftc.teamcode.additional.trajectorysequence.TrajectorySequenceRunner;
import org.firstinspires.ftc.teamcode.additional.util.LynxModuleUtil;
...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.0345;
    ...
    private DcMotorEx upperLeft, lowerLeft, lowerRight, upperRight;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        upperRight = hardwareMap.get(DcMotorEx.class, "upperRight/parallelEncoder");
        upperLeft = hardwareMap.get(DcMotorEx.class, "upperLeft/perpendicularEncoder");
        lowerLeft = hardwareMap.get(DcMotorEx.class, "lowerLeft");
        lowerRight = hardwareMap.get(DcMotorEx.class, "lowerRight");

        upperLeft.setDirection(DcMotorEx.Direction.REVERSE);
        lowerLeft.setDirection(DcMotorSimple.Direction.REVERSE);


        motors = Arrays.asList(upperLeft, lowerLeft, lowerRight, upperRight);
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        upperLeft.setPower(v);
        lowerLeft.setPower(v1);
        lowerRight.setPower(v2);
        upperRight.setPower(v3);
    }
